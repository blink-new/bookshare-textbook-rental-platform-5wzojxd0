      ...
      case 'list':
        return (
          <div className="container mx-auto px-4 py-8">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-4">List Your Book</h2>
              <p className="text-muted-foreground">Coming soon! You'll be able to list your textbooks for rent here.</p>
            </div>
          </div>
        );
      case 'rentals':
        return (
          <div className="container mx-auto px-4 py-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Coming soon! View your rental history and active rentals here.</p>
            </div>
          </div>
        );
      case 'messages':
